...
// presence on an Experience is the only configuration. The GIF and SVG assets
// are bundled with the application (apps/marketing/public/images/) so the
// seamless GIF -> SVG hand-off cannot be broken by editorial asset changes.
//
