...
- [ ] T028 [P] [US2] Storybook story, fixture, or preview coverage for [component/flow]
- [ ] T029 [P] [US2] Jest or route-handler test for [behavior] in `apps/marketing/src/**/__tests__/[name].test.ts`
- [ ] T030 [P] [US2] Integration or Playwright coverage for [user journey] in `apps/marketing/tests/[name].spec.ts`
