...
- **WCAG AA And Layered Storybook UX**: Pass. The feature belongs in higher-level marketing Storybook, with stories covering default, hover/locked, missing-data, neutral unavailable legend treatment, East Coast small-state, Alaska/Hawaii inset, and theme inheritance scenarios. WCAG AA expectations include keyboard operability, screen-reader labeling, focus visibility, contrast on light/dark inherited themes, and non-hover access to state details.
